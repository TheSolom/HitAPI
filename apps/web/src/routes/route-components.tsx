...
import { RequestLogsPage } from '@/features/request-logs';
...
export function RequestLogsRouteComponent() {
    const search = useSearch({ from: '/protected/logs' });
    return <RequestLogsPage {...search} />;
}
